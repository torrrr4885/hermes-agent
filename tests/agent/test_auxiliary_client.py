...
class TestCodexAuxiliaryAdapterTimeout:
    ...
    def test_enforces_total_timeout_while_stream_keeps_emitting_events(self):
        ...
        # Allow modest scheduler jitter on loaded macOS/isolated-uv runners: the
        # invariant is that timeout interrupts before the five-event stream can
        # run to completion, not that the wall clock is sub-140ms on every host.
